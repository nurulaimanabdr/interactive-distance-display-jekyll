...
try:
    while True:
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if not started and start_button.collidepoint(mouse_pos):
                    started = True
                elif started and stop_button.collidepoint(mouse_pos):
                    started = False
        ...
        if started:
            ...
            stop_button = draw_button("Stop", SCREEN_SIZE[0] - 180, SCREEN_SIZE[1] - 70, 160, 50)
        else:
            draw_no_data(SCREEN_SIZE[0]//2, SCREEN_SIZE[1]//2)
            start_button = draw_button("Start", SCREEN_SIZE[0]//2 - 80, SCREEN_SIZE[1]//2 + 100, 160, 60)
